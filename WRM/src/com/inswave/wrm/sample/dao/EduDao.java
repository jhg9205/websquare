...
/*********************************************************************************************/
	...
	public List selectListLWST(Map param) throws Exception {
		System.out.println("파라미터 호출"+param);
		return sqlSession.selectList(NS+"selectSearchList", param);
	}
	
	public List selectListLWSTDetail(int param) throws Exception {
		return sqlSession.selectList(NS+"selectListLWSTDetail", param);
	}
	
	public int updateDetail(Map param) throws Exception {
		return sqlSession.update(NS+"updateDetail", param);
	}
	
	public int deleteDetail(int param) throws Exception {
		return sqlSession.delete(NS+"deleteDetail", param);
	}
/*********************************************************************************************/
}
